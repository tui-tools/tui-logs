...
```sh
curl -fsSL https://github.com/tui-tools/tui-logs/releases/download/v0.2.1/tui-logs_0.2.1_linux_amd64.tar.gz | tar -xz tui-logs
...
Website: https://tui.tools/tools/tui-logs/
<!-- install:end -->
